...
- Name: example.spec.ts >> failed test
- Location: src/tests/example.spec.ts:29:1
...
```ts
  ...
  6  | });
  7  | 
  8  | test('has title', { annotation: [{ type: 'tms', description: '1' }] }, async ({ page }) => {
  ...
  15 |   {
  16 |     annotation: [
  17 |       { type: 'tms', description: '1' },
  18 |       { type: 'tms', description: '1' },
  19 |     ],
  20 |   },
  21 |   async ({ page }) => {
  ...
  31 |   {
  32 |     annotation: [
  33 |       { type: 'tms', description: '1' },
  34 |       { type: 'issue', description: '2' },
  35 |     ],
  36 |   },
  37 |   async ({ page }) => {
  38 |     // Expect a title "to contain" a substring.
> 39 |     await expect(page).toHaveTitle(/WebDriver/);
     |                        ^ Error: expect(page).toHaveTitle(expected) failed
  40 |   }
  41 | );
  42 | 
